...
- ✅ **S11 hecho + MERGED a main (#107)**: aprendizaje/edges puro read-only, 1104/1104 vitest, CI verde incl. E2E, smoke real OK. **Sprint 12** (siguiente, según SPRINT_PLAN: **Design System v3 + shell de 5 superficies** — DS v3, command palette ⌘K, capa global de intervención, migración de rutas; **aquí se vuelven visibles S3/S9/S10/S11**). OJO: S12 es el primer sprint de UI pesada (no puro) — leer el plan + DESIGN_SYSTEM_V3. Deuda S1–S11: limpia.
