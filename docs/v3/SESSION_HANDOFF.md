...
- ✅ **S8 hecho/verificado.** **Sprint 9** (siguiente, según SPRINT_PLAN) — leer el plan para el alcance. Deuda de S1–S8: limpia (D-A cerrada #103; D-B=S7b enhancement). Follow-ups S8: sesgos extra #40, check-in→regla stop (OPEN_ITEMS_SPRINT_8).
