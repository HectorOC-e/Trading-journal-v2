...
- 🔵 **S12 EN CURSO — por partes** (primer sprint de UI pesada; viste el quant de S3–S11). Hecho: **S12a** tokens DS v3 (#108) · **S12b1** ANALIZAR = tabs Institucional(S3)+Edges(S11) en /analytics (#109) · **S12b2** PROTEGER = RiskBudgetMeter + AccountRiskPanel (S9: ruina/proyección/budget) en el detalle de cuenta de /cuentas (#110) — ambos verificados visualmente. **Pendiente:** S12b3 MEJORAR (S10 playbook + S11 transfer/SRS/errores en /playbook), **S12c** shell de 5 superficies + ⌘K **tras feature flag** (alto riesgo, FREEZE: flag off = v2 intacto), S12d intervención global + onboarding. Componentes reutilizables ya hechos: `components/analytics/{r-distribution-chart,equity-drawdown-chart}`, `components/risk/{risk-budget-meter,account-risk-panel}`.
