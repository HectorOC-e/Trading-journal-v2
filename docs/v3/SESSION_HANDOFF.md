...
- 🔵 **S12 EN CURSO — por partes** (primer sprint de UI pesada; viste el quant de S3–S11). Hecho: **S12a** tokens DS v3 (#108) · **S12b1** superficie ANALIZAR = tabs Institucional(S3)+Edges(S11) en /analytics (#109, verificado visualmente). **Pendiente:** S12b2 PROTEGER (S9 riesgo en /cuentas), S12b3 MEJORAR (S10 playbook + S11 transfer/SRS), **S12c** shell de 5 superficies + ⌘K **tras feature flag** (alto riesgo, FREEZE: flag off = v2 intacto), S12d intervención global + onboarding.
